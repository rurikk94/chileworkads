...
<div class="row d-flex justify-content-center">
    <a name="btn-perfil" id="btn-perfil" class="btn btn-warning" href="<?=__URL__?>" role="button">Inicio</a>
    <?php if (is_admin(false)){ ?>
    <a name="btn-admin" id="btn-admin" class="btn btn-primary" href="<?=__URL__?>admin/index.php" role="button">Admin</a>
    <?php } ?>
    <?php if (is_login(false)){ ?>
    <a name="btn-perfil" id="btn-perfil" class="btn btn-success" href="<?=__URL__?>profile/index.php?id=<?=is_login(false)?>" role="button">Perfil</a>
